...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color: darkmagenta; ">
...
## RESULT:
Thus a webserver is designed to design House Price Prediction and is hosted in the URL http://khadar.student.saveetha.in:8000/. HTML code is validated.
